...
local M = class("DDZRulesGoLinkClassic", base)
...
function M:myGoLinkPoke(inData, selectData)
    Log(LOG.TAG.DDZ, LOG.LV.INFO, "==========DDZRulesGoLinkClassic myGoLinkPoke=======")
    ...
    Log(LOG.TAG.DDZ, LOG.LV.INFO, "==========DDZRulesGoLinkClassic no go========")
    return nil
end
